...
def parse_arguments():
    ...
    parser.add_argument("--unfreeze_dino_mode", type=str, default="frozen", choices=["frozen", "last2", "full", "lora"])
    ...
    parser.add_argument("--dino_lora_rank", type=int, default=8, help="LoRA rank when unfreeze_dino_mode=lora")
    parser.add_argument("--dino_lora_alpha", type=float, default=16.0, help="LoRA alpha (scaling = alpha/rank)")
    parser.add_argument("--dino_lora_targets", type=str, default="qkv", help="Comma-separated DINOv2 block targets for LoRA: subset of qkv,proj,fc1,fc2")
    parser.add_argument("--dino_lora_blocks", type=str, default="all", help="Block indices for LoRA injection: 'all' or underscore-separated, e.g. '7_15_23'")
