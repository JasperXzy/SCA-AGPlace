...
def compute_other_loss(feats_ground, feats_aerial, data_dict, positive_thd=10, negative_thd=25, args=None):
    ...
    bcemat_Gimageorg_AembedGimageorg = compute_bcemat(
        eastnorthdist_Gimageorg_AembedGimageorg, positive_thd, negative_thd
    )
    ...
    loss_Gembed_AembedGembed = compute_loss(
        featsdist_Gembed_AembedGembed, bcemat_Gembed_AembedGembed, args.otherloss_type
    )
    loss_Gimageorg_AembedGimageorg = compute_loss(
        featsdist_Gimageorg_AembedGimageorg, bcemat_Gimageorg_AembedGimageorg, args.otherloss_type
    )
    loss_Gvoxorg_AembedGvoxorg = compute_loss(
        featsdist_Gvoxorg_AembedGvoxorg, bcemat_Gvoxorg_AembedGvoxorg, args.otherloss_type
    )
